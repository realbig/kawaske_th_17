...
(0, _jquery2.default)(function () {
    ...
    var $galleries = (0, _jquery2.default)('.gallery');
...
function galleryInit() {
    ...
    var matches = (0, _jquery2.default)(this).attr('id').match(/gallery-(\d+)/i);
    var instance = matches[1];
    var $modal = (0, _jquery2.default)('#kwaske-gallery-modal-' + instance);
    var images = JSON.parse($modal.attr('data-images'));

    (0, _jquery2.default)(this).find('.gallery-item a').click(function (e) {

        e.preventDefault();

        var $item = (0, _jquery2.default)(this).closest('.gallery-item');
        var index = $item.index();
        var $loading = $modal.find('.kwaske-gallery-modal-loading');
        var $imageContainer = $modal.find('.kwaske-gallery-modal-image-container');
